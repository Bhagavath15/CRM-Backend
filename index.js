...
app.post("/dashboard", auth, async function (request, response) {
...
app.put("/dashboard/:id", auth, async function (request, response) {
    const { id } = request.params
...
app.delete('/dashboard/:id', auth, async function (request, response) {
    const { id } = request.params
    console.log(id)
